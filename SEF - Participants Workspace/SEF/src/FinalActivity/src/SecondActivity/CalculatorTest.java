...
public class CalculatorTest extends Calculator{
    ...
    public void subtract() {
        assertEquals(0, calculator.substract(1, 1), 0);
        assertEquals(4.86, calculator.substract(3.14, -1.72), 0.001);
        assertEquals(2.0/3, calculator.substract(1.0/3, -1.0/3), 0.001);
    }
